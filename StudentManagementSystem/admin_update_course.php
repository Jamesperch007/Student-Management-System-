...
error_reporting(0);
	...
	if(isset($_POST['update_course']))
	{
		...
		if($file)
		{
			$sql2="UPDATE course SET name='$c_name',description='$c_des',image='$dst_db' WHERE id='$id' ";
		}

		else
		{
			$sql2="UPDATE course SET name='$c_name',description='$c_des' WHERE id='$id' ";
		}
	...
	<div class="content">
		...
		<form class="form_deg" action="admin_update_course.php" method="POST" enctype="multipart/form-data">
			...
			<div>
				...
				<textarea name="description" rows="4" column="5">
